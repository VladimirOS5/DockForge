...
> Текущая версия: v1.0.0-alpha | Последний чат: 04
...
- [x] TweenEngine: time-based, 7 easing curves (Linear, EaseOut, EaseInOut, EaseOutBack, EaseOutBounce, EaseOutCirc, Elastic)
...
- [ ] Audio-reactive шейдер (WASAPI)
- [ ] Gradient flow, particle system
...
*Последнее обновление: Chat 04 | Следующий: Chat 05 — Shell интеграция*
